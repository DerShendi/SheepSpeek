        ...
        public ServerConfig(ModConfigSpec.Builder builder) {
            ...
            messages = builder.defineList(
                    ...
                    List.of(
                            ...
                            "Its ok to feel like the other gender <3?",
                            ...
                            "Excuse me, Are you British?? ... Oh no... Oh no no no no no no. Hatsune Miku does NOT talk to British People. the only £s I need are me £ing your mum. SEKAAAAAA",
                            "Baa-rmor? More like baa-oring!",
                            "My wool grows back - does your ego?",
                            "Bet you wish you could grow a rainbow coat like mine!",
                            "I'm feeding you a slice of white bread",
                            "We need to do the white bread test",
                            "He likes it a lil",
                            "I'm going to elminate the middle class",
                            "IS THAT THE BITE OF 87???",
                            "Har Har Har Har Har Har Har Har Har Har",
                            "#FreddyFiveNightsForPresident2028",
                            "FreddyFazzballs",
                            "That looks like the BattlePass",
                            "Fortnite",
                            "Have you heard of this character called Sonichu?",
                            "Would you like to meet my parents sometimes?",
                            "Society",
                            "Let me get this straight Mort. You think killing these guys is funny?",
                            ...
                            "King JULIEEEEEEEEEEEEN",
                            "Whats up guys, and welcome to my Minecraft lets play part 47. Today were going to kill the wither",
                            "I was just enjoying some Sauerkraut. It has some sand in it but its OK.",
                            "Man i love Frogs",
                            "I need to make a stop to Blockbuster to return my copy of Velocipastor",
                            "Our lord who art in Heaven Baha be thy Blast Amen",
                            "Its so sad that you came down with a case of Bonkya Player",
                            "Lets do some Team bonding exercises, Whats your favorite organ you like to steal from people?",
                            "Orphans dont have rights",
                            "Player I want to enlighten you about the lore of Five Nights at Freddys.",
                            "So the entire story starts with this random guy William Afton also known as Springtrap lateron",
                            "Im calling him Michael Theodore Mouse because Mickey if for friends and I'll be damned if I'd consider that RAT a friend of mine",
                            "If you feel like life has gotten you down always remember 'At least im not mining for bitcoin on your PC' :)",
                            "Imma be honest here, Im fighting Homelessness here. Soon it will be the Homeless",
                            "I need to meet the Doctor again",
